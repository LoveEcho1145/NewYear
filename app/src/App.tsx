  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#1a0505] via-[#2d0a0a] to-[#1a0505] relative overflow-hidden">
      ...
      <div className="relative z-20 min-h-screen flex flex-col">
        ...
        >
          <div className="inline-flex items-center gap-2 mb-2 animate-pulse-gold">
            ...
            <span className="text-festive-gold/80 text-sm md:text-base tracking-widest">
              丁未瑞羊・吉羊纳福
            </span>
            <Sparkles className="w-5 h-5 text-festive-gold" />
          </div>
          ...
          <div 
            className={`flex items-center justify-center gap-3 text-festive-gold/60
          ...
          {isComplete ? (
            ...
            >
              <div className="animate-float">
                <Star className="w-32 h-32 mx-auto text-festive-gold mb-6" />
              </div>
              <h2 className="text-5xl md:text-7xl font-bold text-gradient-gold mb-4">
                羊年大吉！
              </h2>
              <p className="text-xl md:text-2xl text-festive-gold/80">
                祝您新春快乐，万事如意
              </p>
            </div>
          ) : (
            <>
              {/* Target Date Info */}
              <div 
                className={`flex items-center gap-2 mb-8 text-festive-gold/70
              ...
              >
                <div className="w-16 md:w-32 h-px bg-gradient-to-r from-transparent to-festive-gold/50" />
                <Clock className="w-5 h-5 text-festive-gold/60" />
                <div className="w-16 md:w-32 h-px bg-gradient-to-l from-transparent to-festive-gold/50" />
              </div>
        ...
        >
          <div className="flex items-center justify-center gap-2 text-festive-gold/40 text-sm">
            <Star className="w-4 h-4" />
            <span>丁未羊年・火运昌隆</span>
            <Star className="w-4 h-4" />
          </div>
          <p className="text-festive-gold/30 text-xs mt-2">
            天干丁属火・地支未为羊・天运五行属木
          </p>
        </footer>
      </div>
      ...
      <div className="fixed top-0 left-0 w-32 h-32 pointer-events-none z-30">
        <div className="absolute top-4 left-4 w-16 h-16 border-t-2 border-l-2 border-festive-gold/30" />
      </div>
      <div className="fixed top-0 right-0 w-32 h-32 pointer-events-none z-30">
        <div className="absolute top-4 right-4 w-16 h-16 border-t-2 border-r-2 border-festive-gold/30" />
      </div>
      <div className="fixed bottom-0 left-0 w-32 h-32 pointer-events-none z-30">
        <div className="absolute bottom-4 left-4 w-16 h-16 border-b-2 border-l-2 border-festive-gold/30" />
      </div>
      <div className="fixed bottom-0 right-0 w-32 h-32 pointer-events-none z-30">
        <div className="absolute bottom-4 right-4 w-16 h-16 border-b-2 border-r-2 border-festive-gold/30" />
      </div>
    </div>
  );
}
